...
import { generateStudyPlan, generateQuiz, askQuestion } from '@/src/services/gemini';
...
export default function StudyTools() {
  ...
  useEffect(() => {
    ...
    const progress = localStorage.getItem('ie_matrix_progress');
    if (progress) {
      setProgressMap(JSON.parse(progress));
    }
      ...
      <main className="flex-1 p-6 lg:p-10 pb-32 lg:pb-10 overflow-x-hidden">
          ...
          <AnimatePresence mode="wait">
            ...
            >
              ...
              <TabsContent value="map" className="mt-0">
                <GlowCard className="p-10 min-h-[600px] flex flex-col items-center relative overflow-hidden" glowColor="blue">
                  <div className="absolute top-10 left-10 text-left">
                    <h2 className="text-3xl font-bold mb-2">Academic Matrix Map</h2>
                    <p className="text-sm text-foreground/40 max-w-md">Visualizing the flow of Industrial Engineering subjects from fundamentals to specialization.</p>
                  </div>
              ...
              <TabsContent value="qa" className="mt-0 space-y-6">
                <div className="flex gap-4">
                  ...
                  <Dialog open={isAskQuestionModalOpen} onOpenChange={setIsAskQuestionModalOpen}>
                    <DialogTrigger>
                      <Button className="h-14 px-8 rounded-2xl bg-ctu-maroon text-white font-bold">Ask Question</Button>
                    </DialogTrigger>
                    <DialogContent className="sm:max-w-[425px] neumorphic-card border-none">
                      <DialogHeader>
                      ...
                      <div className="flex gap-6">
                        ...
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2">
                             <Badge className="bg-brand-accent/10 text-brand-accent border-none text-[10px] font-bold">{q.subjectTag || 'General'}</Badge>
              ...
              <TabsContent value="flashcards" className="mt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                  {[
                    ...
                    { title: 'Work Measurement', cards: 15, color: 'maroon' },
                    { title: 'Ergonomics Basics', cards: 32, color: 'gold' }
                  ].map((deck, i) => (
              ...
              <TabsContent value="quizzes" className="mt-0">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  <GlowCard className="p-8" glowColor="gold">
                    <div className="flex items-start justify-between mb-8">
                      <div>
                    ...
                    <div className="space-y-4 mb-8">
                      <div className="flex justify-between items-center p-4 rounded-xl neumorphic-pressed">
                        ...
                        <Badge className="bg-ctu-gold/10 text-ctu-gold border-none">Ready</Badge>
                      </div>
                  ...
                  <div className="grid grid-cols-1 gap-6">
                    ...
                    <Card className="neumorphic-card border-none p-6">
                      <div className="flex items-center justify-between mb-4">
                        ...
                        <TrendingUp size={16} className="text-ctu-gold" />
                      </div>
                      <div className="space-y-3">
                         <div className="flex justify-between items-center text-xs">
                           <span className="font-medium">Work Measurement</span>
                           <span className="font-bold text-ctu-gold">92%</span>
                         </div>
        ...
        <Dialog open={!!selectedQuestion} onOpenChange={(open) => !open && setSelectedQuestion(null)}>
          <DialogContent className="max-w-2xl bg-background rounded-3xl border-none p-8">
            <DialogHeader>
              <div className="flex items-center gap-3 mb-2">
                <Badge className="bg-brand-accent/10 text-brand-accent border-none text-[10px] font-bold">{selectedQuestion?.subjectTag || 'General'}</Badge>
