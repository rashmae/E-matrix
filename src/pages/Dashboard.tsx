        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-10">
          ...
          <div className="flex flex-col items-end gap-3 translate-y-2">
            ...
            <div className="hidden md:flex items-center gap-2">
              <Filter size={12} className="text-ctu-gold mr-1" />
        ...
        >
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
              {[
                { label: 'Total Subjects', value: stats.total.toString(), icon: BookOpen, color: 'text-foreground/40', bg: 'bg-foreground/5' },
                ...
                { label: 'Standing', value: `GWA ${stats.gwa}`, icon: LayoutDashboard, color: 'text-brand-accent', bg: 'bg-brand-accent/10' },
              ].map((stat, i) => (
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {[
                  { 
                    ...
                    gradient: 'from-ctu-maroon to-brand-accent', 
                    badge: 'bg-ctu-maroon',
                    glow: 'shadow-[0_0_15px_rgba(47,46,51,0.2)]'
                  },
                  { 
                    id: '2nd',
                    year: '2nd Year', 
                    subjects: subjectsByYear['2nd'],
                    gradient: 'from-ctu-gold to-brand-accent', 
                    badge: 'bg-ctu-gold',
                    glow: 'shadow-[0_0_15px_rgba(22,20,21,0.2)]'
                  },
                  { 
                    id: '3rd',
                    year: '3rd Year', 
                    subjects: subjectsByYear['3rd'],
                    gradient: 'from-brand-accent to-ctu-maroon', 
                    badge: 'bg-brand-accent',
                    glow: 'shadow-[0_0_15px_rgba(189,178,176,0.2)]'
                  },
                  { 
                    id: '4th',
                    year: '4th Year', 
                    ...
                    gradient: 'from-ctu-gold to-brand-accent', 
                    badge: 'bg-ctu-gold',
                    glow: 'shadow-[0_0_15px_rgba(243,186,81,0.2)]'
                  },
                ].map((year, i) => {
            ...
            <motion.div variants={itemVariants}>
              <div className="flex items-center justify-between mb-6">
                ...
                <button 
                  ...
                  className="text-ctu-gold text-sm font-bold flex items-center gap-1 hover:underline"
                >
                  View Library <ChevronRight size={16} />
                </button>
              </div>
              <ScrollArea className="w-full whitespace-nowrap rounded-xl">
                <div className="flex gap-8 pb-10 px-4">
                  {IE_SUBJECTS.filter(s => !progressMap[s.id] || progressMap[s.id].status !== 'done').slice(0, 6).map((subject, idx) => (
                    <GlowCard 
                      key={subject.id} 
                      glowColor={idx % 2 === 0 ? 'gold' : 'maroon'}
                      customSize
                      className="w-72 h-44 shrink-0 hover:scale-[1.05] transition-all cursor-pointer border-none flex flex-col justify-between"
                    ...
                    >
                      <div className="relative z-10">
                        ...
                        <h4 className="font-bold text-foreground truncate text-lg">{subject.name}</h4>
                      </div>
