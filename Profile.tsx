...
export default function Profile() {
  ...
  const updateProfilePhoto = (photoData: string) => {
    if (!user) return;
          ...
          <div className="space-y-10">
            <Card className="neumorphic-card border-none overflow-hidden">
              ...
              <CardContent className="p-8 -mt-14 flex flex-col items-center text-center">
                ...
                <p className="text-ctu-gold font-bold text-sm tracking-widest uppercase mt-2">{user.idNumber}</p>
                <div className="flex gap-3 mt-6">
                  <Badge className="neumorphic-pressed text-foreground/60 border-none px-4 py-1 rounded-full text-[10px] uppercase font-bold">BSIE Student</Badge>
                  <Badge className="bg-ctu-maroon/20 text-ctu-maroon border-none px-4 py-1 rounded-full text-[10px] uppercase font-bold">Active</Badge>
                </div>
              </CardContent>
            </Card>
          ...
          <div className="lg:col-span-2 space-y-10">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="p-6 rounded-3xl neumorphic-pressed">
                    <h4 className="font-bold text-foreground mb-4 flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-brand-accent/10 flex items-center justify-center text-[10px] text-brand-accent font-bold">iOS</div>
                      For iPhone/iPad
                    </h4>
                  ...
                  <div className="p-6 rounded-3xl neumorphic-pressed">
                    <h4 className="font-bold text-foreground mb-4 flex items-center gap-3">
                      <div className="w-8 h-8 rounded-full bg-ctu-gold/10 flex items-center justify-center text-[10px] text-ctu-gold font-bold">AND</div>
                      For Android
                    </h4>
                    <ol className="text-xs text-foreground/40 space-y-3 list-decimal list-inside font-bold uppercase tracking-widest">
            ...
            <div className="lg:hidden pt-4">
              <button 
                ...
                className="w-full flex items-center justify-center gap-3 p-5 rounded-3xl neumorphic-raised text-ctu-maroon font-bold transition-all active:neumorphic-pressed"
              >
                <LogOut size={22} />
